...
PackageExport["prepareSegmentationDataCompiled"]
...
PackageExport["FoveaParameterInterpolation"]
FoveaParameterInterpolation::usage = "FoveaParameterInterpolation[{params1, params2, ...}] interpolates a set of fovea model parameters with Steffen's method.";
FoveaParameterInterpolation[params : {{_, _, _, _}..}] := With[
  {
    ip = SteffenInterpolation[
      Transpose[{Range[0, 2.0 Pi, 2.0 Pi / (Length[#])], Append[#, First[#]]}],
      PeriodicInterpolation -> True
    ] & /@ Transpose[params]
  },
  Function[phi, Through[ip[Mod[phi, 2 Pi]]]]
];
